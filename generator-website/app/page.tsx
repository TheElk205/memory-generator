          ...
          <nav className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              ...
              <div className="flex space-x-1">
                <a
                  href="/"
                  className="px-4 py-2 text-white bg-green-600 rounded-md font-medium"
                >
                  Memory Generator
                </a>
                <a
                  href="/bingo"
                  className="px-4 py-2 text-gray-600 hover:text-purple-600 hover:bg-purple-50 rounded-md transition-colors"
                >
                  BINGO Generator
                </a>
              </div>
